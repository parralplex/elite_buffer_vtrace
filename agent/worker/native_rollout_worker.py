...
def start_worker(options_flags, observation_shape, action_count, id, queue, shared_list, stop_event, verbose=False):
    rollout_worker = RolloutWorker(options_flags, observation_shape, action_count, id, verbose)
